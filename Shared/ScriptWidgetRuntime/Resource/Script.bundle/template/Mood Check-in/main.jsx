...
$render(<vstack frame="max" spacing="10" padding="14" background="#7c3aed"><hstack frame="max"><text font="headline" weight="bold" color="white">How are you?</text><spacer/><icon systemName="face.smiling" size="22" color="#ede9fe"/></hstack><spacer/><hstack spacing="10"><text font="title">😌</text><text font="title">🙂</text><text font="title">😊</text><text font="title">🤩</text></hstack><spacer/><text font="caption" color="#f5f3ff">{note}</text></vstack>);
